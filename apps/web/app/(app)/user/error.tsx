...
export default function UserAppError(props: {
  error: Error & { digest?: string };
  reset: () => void;
}) {
  return (
    <div className="rounded-3xl border border-rose-400/20 bg-black/20 p-8 text-rose-50">
      <p className="text-xs uppercase tracking-[0.24em] text-rose-300">Customer Route Error</p>
      <h1 className="mt-4 text-3xl font-semibold">Customer workspace failed to render</h1>
